...
class RFPO02(PPO):
    def __init__(self, actor_class, critic_class, env, **hyperparameters):
        ...
        # === [新增] 获取正则化系数 ===
        self.cfm_coef = hyperparameters.get('cfm_coef', 0.0)
        ...
        while t_so_far < total_timesteps:
            ...
            for _ in range(self.n_updates_per_iteration):
                ...
                for start in range(0, step, minibatch_size):
                    ...
                    reflow_loss = cfm_loss.mean()
                    actor_loss += self.cfm_coef * reflow_loss
                    ...
                    metrics = {
                        ...
                        "reflow_loss_term": reflow_loss.item(),
            ...
            if i_so_far % self.save_freq == 0:
                torch.save(self.actor.state_dict(), './rfpo02_actor.pth')
                torch.save(self.critic.state_dict(), './rfpo02_critic.pth')
