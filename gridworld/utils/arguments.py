...
def get_args():
        ...
        parser.add_argument('--method', dest='method', type=str, default='fpo')             # can be 'ppo' or 'fpo'
        parser.add_argument('--cfm_coef', dest='cfm_coef', type=float, default=None, 
                            help='Coefficient for the CFM regularization loss (Reflow loss)')
